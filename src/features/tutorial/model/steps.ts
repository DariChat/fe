...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    route: '/discover',
    title: '여기서 사람을 만나요',
    body: '나와 다른 언어를 쓰는 사람을 추천해 드려요. 자기소개를 보고 마음이 가면 친구 요청을 보내면 됩니다.',
    placement: 'top',
    padding: 6,
  },
  {
    ...
    route: '/discover',
    title: '번역은 자동으로 됩니다',
    body: '상대가 어떤 언어로 보내든 내가 고른 언어로 바꿔서 보여줘요. 원문이 궁금하면 말풍선 아래 "원문 보기"를 누르면 됩니다.',
    placement: 'bottom',
    padding: 6,
  },
  {
  ...
  },
  {
    ...
    route: '/rooms',
    title: '내 언어를 정해 두세요',
    body: '지금 설정된 언어로 상대의 메시지가 번역돼요. 프로필에서 자기소개와 함께 바꿀 수 있습니다.',
    placement: 'right',
  },
  {
    id: 'theme',
